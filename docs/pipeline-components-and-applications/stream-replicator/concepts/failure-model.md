...
You can find more detail on setting up a failure target, in the [configuration section](/docs/pipeline-components-and-applications/stream-replicator/configuration/targets).
